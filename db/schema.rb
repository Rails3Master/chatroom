...
ActiveRecord::Schema.define(:version => 20130724160000) do
  ...
  create_table "contacts", :force => true do |t|
    ...
    t.integer  "friend_id"
    t.text     "content"
    t.boolean  "confirm_flag", :default => false
    t.datetime "deleted_at"
    t.datetime "created_at",                      :null => false
    t.datetime "updated_at",                      :null => false
  end
  ...
  create_table "group_tasks", :force => true do |t|
    t.integer  "task_id"
    t.integer  "group_id"
    t.string   "issue_status", :default => "0"
    t.datetime "deleted_at"
    t.datetime "created_at",                    :null => false
    t.datetime "updated_at",                    :null => false
  end
  ...
  create_table "users", :force => true do |t|
    ...
    t.datetime "created_at",                                            :null => false
    t.datetime "updated_at",                                            :null => false
    t.string   "uuid_random"
    t.integer  "company_id",             :limit => 10
    t.string   "name",                   :limit => 50
    t.string   "tel",                    :limit => 20
    t.string   "skype_id",               :limit => 20
    t.string   "zip_code",               :limit => 20
    t.string   "address1",               :limit => 100
    t.string   "address2",               :limit => 100
    t.string   "photo_path",             :limit => 100
