Chatroom::Application.routes.draw do
  ...
  devise_for :admins, :controllers => {:sessions => "admins/sessions"}#, :path_names => { :sign_in => 'login'}
  ...
  #match '/admins' => 'admins#index', :as => :admin_root
  #match 'admin' => 'admin#admin#index'#, :as => :admin_root
  ##get 'admins' => "admins#sign_in"
  ##resource :contact
  #
  #namespace :admin do
  #  resources 'admin' do
